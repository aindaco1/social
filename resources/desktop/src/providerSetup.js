...
export const dustWaveTikTokReviewGate = 'Configure and save Sandbox first, then use Production > Import > Import from Sandbox; save the Production draft, then add a real target account and demo video before review.';
