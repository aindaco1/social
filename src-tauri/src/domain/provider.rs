...
pub fn provider_capabilities() -> Vec<ProviderCapability> {
    vec![
        ...
        ProviderCapability {
            ...
            notes: vec![
                "Instagram uses the shared Meta OAuth app and professional accounts connected to Facebook Pages.",
                "MVP direct publishing supports static image posts through a public HTTPS staging URL.",
                "Reels, stories, carousels, and direct local-file upload are staged for follow-up provider work.",
            ],
        },
        ProviderCapability {
            id: "mastodon",
        ...
        ProviderCapability {
            ...
            notes: vec![
                "TikTok is MVP scope through assisted publishing plus broker-backed analytics.",
                "Direct API publishing is intentionally disabled until video.upload or video.publish is approved for the app.",
                "Analytics imports require user.info.stats and video.list scopes through the Dust Wave broker.",
            ],
        },
        ProviderCapability {
            id: "facebook_group",
