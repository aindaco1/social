...
- Apple accepted app submission `612a4492-7b27-44f6-ba03-302c763cc23c`.
- Apple accepted DMG submission `8e278174-0da3-4cee-a72b-74ce900009bb`; stapler validation and Gatekeeper assessment passed.
- Published DMG SHA-256: `6b2fbf9aa0887cc50322c761bbc86a7a47dd44db84dd2a8170eb829bc4a6ff0f`.
- Published updater archive SHA-256: `400f43ea32929979d2bccc9f411918119512ddaa0e98f8f75bdd292407137a6c`.
- Published updater signature SHA-256: `5603f975892a29b7a71145bbeba4b34deb2277bf7b936573fdb5555e07ff606f`.
- Published app ZIP SHA-256: `558ff794c625ea0a47a89d9f26d7a9c87bc3343d6a1c390f6c4b3dfb8e0b5156`.
- Published `latest.json` SHA-256: `45a8703db3addf7964cc297c165c290ddae58984696868b59d042f7905eb2dee`.
- Approved app and DMG volume icon SHA-256: `48c20e2e3928cee00bda065dfa59c34a80daf1d340d93d8feaefcb4e97860783`.
- The protected [v0.1.9 tag workflow](https://github.com/aindaco1/social/actions/runs/32996133002) passed release checks, signing, app and DMG notarization/stapling, strict artifact verification, publication, and public manifest verification in 13 minutes 45 seconds.
- The protected updater smoke downloaded the public v0.1.8 app, installed all 46,356,987 signed updater bytes, verified the staged bundle changed to v0.1.9, and proved the automatic process hop from PID 40834 to PID 40934.
- An independent post-publication download reproduced all five GitHub asset digests, matched the live manifest and updater signature asset, validated the stapled DMG ticket and `/Applications` layout, passed Gatekeeper and disk-image verification, and verified the mounted, updater-archive, and app-ZIP bundles' code signatures, stapled tickets, `com.dustwave.social` identity, arm64 architecture, v0.1.9 version, and byte-identical approved icons.

The first 0.1.1 candidate passed signing, notarization, artifact checks, and updater installation, but its workflow incorrectly checked the untouched source app after updating a canonical staged copy. The fail-closed workflow returned that candidate to draft. Version 0.1.2 moved the version assertion into the staged-app harness and published only after the corrected hop passed. A second local packaged-app download smoke timed out on the preserved local 0.1.0 build even though the same archive downloaded directly in 1.55 seconds. Version 0.1.8 is the immediate rollback baseline for v0.1.9; version 0.1.0 remains the earliest archived known-good release.
...
- The v0.1.9 tag workflow completed in 13 minutes 45 seconds, 10 minutes 13 seconds (about 43%) faster than the v0.1.8 baseline of 23 minutes 58 seconds. Both rebuild the tagged source and rerun every release gate; the v0.1.9 run reused only exact-commit Cargo compilation intermediates and LGPL sidecars, never final executables or bundles.
